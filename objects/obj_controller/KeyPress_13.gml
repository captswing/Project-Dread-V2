...
//create_textbox_decision(4, ["", "", ""], ["#next", "", ""]);

/*create_textbox("Reflecting on that thought, Claire makes yet another realization...");

create_textbox_actor_portrait("The thing I really like about Planes is that we learn that WWII happened in the Cars universe.", Actor.Claire, 2);
create_textbox_actor_portrait("Which means there was a Cars Hitler, a Cars holocaust, a Cars Pacific War, a Cars D-Day, a Cars nuking of Hiroshima and Nagasaki, a Cars Rape of Nanking, a Cars Battle of Iwo Jima...", Actor.Claire, 1);

...
function file_fast_crypt_ultra(_filename_in, _filename_out, _is_encrypting, _enc_key) {
	...
	// Version 1.42 - 2nd February 2020
...
/// @description Converts a number from hexidecimal to decimal
/// @param hex
